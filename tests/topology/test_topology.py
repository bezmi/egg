...
class TestTopologyBuilder:
    def test_rejects_wrong_corner_count(self):
        ...
        builder.add_corner("A", (0.0, 0.0))
        builder.add_corner("B", (1.0, 0.0))
        builder.add_corner("C", (1.0, 1.0))
...
class TestSingularityDetection:
    ...
    def test_two_block_shared_edge_no_singularities(self):
        ...
        (
            ...
            .add_corner("E", (4.0, 0.0), fixed=True)
            .add_corner("F", (4.0, 2.0), fixed=True)
    ...
    def test_three_block_junction_regular_valence(self):
        ...
        """
        builder = TopologyBuilder(d=2)
        builder.add_corner("sw", (0.0, 0.0), fixed=False)
        builder.add_corner("nw", (0.0, 2.0), fixed=False)
        builder.add_corner("se", (2.0, 0.0), fixed=False)
        builder.add_corner("ne", (2.0, 2.0), fixed=False)
        builder.add_corner("e_se", (4.0, 0.0), fixed=False)
        builder.add_corner("e_ne", (4.0, 2.0), fixed=False)
        builder.add_corner("n_nw", (0.0, 4.0), fixed=False)
        builder.add_corner("n_ne", (2.0, 4.0), fixed=False)
